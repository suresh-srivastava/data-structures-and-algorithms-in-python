...
class UndirectedGraph:
	...
	def _dfs(self, vertex):
		...
		self._vertex_list[vertex].discovery_time = UndirectedGraph.time	# discovery time
		...
		UndirectedGraph.time += 1
		self._vertex_list[vertex].finishing_time = UndirectedGraph.time	# finishing time
